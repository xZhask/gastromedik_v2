...
$router->get('/api/session',    [PageController::class, 'session'])->middleware($auth);
...
$router->get   ('/api/atenciones/{id}/examen',      [AtencionController::class, 'showExamen'])          ->middleware($auth);
...
$router->post  ('/api/atenciones/tratamiento',      [AtencionController::class, 'registrarTratamiento'])->middleware($csrf);
$router->post  ('/api/atenciones/subir-archivo',    [AtencionController::class, 'subirArchivo'])        ->middleware($csrf);
$router->post  ('/api/atenciones/carrito',          [AtencionController::class, 'agregarCarrito'])      ->middleware($auth);
$router->delete('/api/atenciones/carrito/{codigo}', [AtencionController::class, 'quitarCarrito'])       ->middleware($auth);
$router->delete('/api/atenciones/carrito',          [AtencionController::class, 'cancelarCarrito'])     ->middleware($auth);
